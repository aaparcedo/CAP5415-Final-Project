...
DATASET="rvos"
LOGFILE="/home/aparcedo/IASEB/results/${SLURM_JOB_ID}_vrshq_${DATASET}_preds.json"
...
# Run the code
/home/aparcedo/.conda/envs/vrshq/bin/python vrshq_eval.py --output_path $LOGFILE --dataset ${DATASET} 