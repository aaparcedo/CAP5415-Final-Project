...
def process_video_data(json_data, stop_num):
    ...
    for video in json_data:
        ...
        TEXT_PROMPT = caption
        OUTPUT_VIDEO_PATH = f"./vidstg_eval_result/video_output/{video_ID}_tracking_demo.mp4"
        SOURCE_VIDEO_FRAME_DIR = f"./vidstg_eval_result/video_frames/{video_ID}"
        SAVE_TRACKING_RESULTS_DIR = f"./vidstg_eval_result/tracking_results/{video_ID}"
...
if __name__ == '__main__':
    ...
    data = read_json_file("/home/we337236/stvg/dataset/vidstg/vidstg_pro_test_final_list.json")
