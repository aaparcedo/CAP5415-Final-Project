...
def process_video_data(json_data, stop_num):
    ...
    for video in json_data:
        ...
        TEXT_PROMPT = caption
        OUTPUT_VIDEO_PATH = f"./sth_else_eval_result/phrase/video_output/{video_ID}_tracking_demo.mp4"
        SOURCE_VIDEO_FRAME_DIR = f"./sth_else_eval_result/phrase/video_frames/{video_ID}"
        SAVE_TRACKING_RESULTS_DIR = f"./sth_else_eval_result/phrase/tracking_results/{video_ID}"
...
if __name__ == '__main__':
    ...
    data = read_json_file("/home/we337236/stvg/dataset/something_else/something_else_coco_format.json")
