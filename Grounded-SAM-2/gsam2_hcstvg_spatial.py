...
def process_video_data(json_data, stop_num, version):
    vIoU_list = []
    ...
    for video in json_data:
        ...
        if version == 1:
            ...
            TEXT_PROMPT = caption
            OUTPUT_VIDEO_PATH = f"./hcstvgv1_eval_result/free_form/hcstvg_video_output/{video_ID}_tracking_demo.mp4"
            SOURCE_VIDEO_FRAME_DIR = f"./hcstvgv1_eval_result/free_form/hcstvg_video_frames/{video_ID}"
            SAVE_TRACKING_RESULTS_DIR = f"./hcstvgv1_eval_result/free_form/hcstvg_tracking_results/{video_ID}"
        elif version == 2:
            VIDEO_PATH = f"/home/c3-0/datasets/stvg/hcstvg2/videos/{video_path}"
            TEXT_PROMPT = caption
            OUTPUT_VIDEO_PATH = f"./hcstvgv2_eval_result/free_form/hcstvg_video_output/{video_ID}_tracking_demo.mp4"
            SOURCE_VIDEO_FRAME_DIR = f"./hcstvgv2_eval_result/free_form/hcstvg_video_frames/{video_ID}"
            SAVE_TRACKING_RESULTS_DIR = f"./hcstvgv2_eval_result/free_form/hcstvg_tracking_results/{video_ID}"
...
if __name__ == '__main__':
    ...
    m_vIoU, vIoU_3, vIoU_5 = process_video_data(data, num_vid, version)
