...
def process_video_data(json_data, stop_num):
    ...
    for video in json_data:
        ...
        TEXT_PROMPT = caption
        OUTPUT_VIDEO_PATH = f"./vidvrd_eval_result/referral/video_output/{video_ID}_tracking_demo.mp4"
        SOURCE_VIDEO_FRAME_DIR = f"./vidvrd_eval_result/referral/video_frames/{video_ID}"
        SAVE_TRACKING_RESULTS_DIR = f"./vidvrd_eval_result/referral/tracking_results/{video_ID}"
        ...
        if id_count %100 == 0:
            ...
            with open('/home/we337236/stvg/Grounded-SAM-2/vidvrd_eval_result/referral/log/vIoU_list.pkl', 'wb') as f:
