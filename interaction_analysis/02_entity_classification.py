...
# COMMENTING THIS OUT BECAUSE IT SHOULD BE REPLACED WITH THE HIERARCHY FROM constants.py
HIERARCHY = """
1.0 Human-Human
...
7.0 Human-Self Self-interaction (e.g., cover mouth, raise hand)
8.0 No Interaction A single agent or object acting in isolation.
"""
...
import json
def classify_mevis_rvos():
    fp = '/home/aparcedo/IASEB/interaction_analysis/mevis_rvos_captions.json'
    data = json.load(open(fp, 'r'))
    for sample in tqdm(data, desc="Classifying..."):
        category = classify(sample["caption"])
        sample['entity_class_raw'] = category

    output_path = "mevis_rvos_gpt4omini_entity_class_v1.json"
