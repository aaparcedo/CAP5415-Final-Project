...
def main(args):
    ...
    raw_output_file = os.path.join(output_dir, "hcstvg1_phrase_predictions_raw_t.json")
    with open(raw_output_file, "w") as f:
        json.dump(results_list, f, indent=4)

    coco_output_file = os.path.join(output_dir, "hcstvg1_phrase_predictions_coco_t.json")
