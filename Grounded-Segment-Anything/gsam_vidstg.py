...
class vidstgDataset:
    def __init__(self, caption_type, transform=None):
        ann_path = "/home/we337236/stvg/dataset/vidstg/vidstg_pro_test_final_list.json"
        frame_path = "/home/we337236/stvg/Grounded-SAM-2/vidstg_eval_result/video_frames"
...
if __name__ == "__main__":
    ...
    vIoU_list=[]
    count = 0
    for entries, frame_lists in tqdm(data_loader, desc=f"Evaluating vidstg"):
