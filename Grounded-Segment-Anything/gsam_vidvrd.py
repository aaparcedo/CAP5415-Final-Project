...
class vidstgDataset:
    def __init__(self, caption_type, transform=None):
        if caption_type == "free_form":
            ann_path = "/home/we337236/stvg/dataset/vidvrd/free_form_final_output.json"
            frame_path = "/home/we337236/stvg/Grounded-SAM-2/vidvrd_eval_result/free_form/video_frames"
        elif caption_type =="referral":
            ann_path = "/home/we337236/stvg/dataset/vidvrd/referral_final_output.json"
            frame_path = "/home/we337236/stvg/Grounded-SAM-2/vidvrd_eval_result/referral/video_frames"
...
if __name__ == "__main__":
    ...
    dataset = vidstgDataset(args.caption_type, transform)
    ...
    vIoU_list=[]
    count = 0
    for entries, frame_lists in tqdm(data_loader, desc=f"Evaluating vidvrd"):
